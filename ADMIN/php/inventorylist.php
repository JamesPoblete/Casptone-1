...
$sql = "SELECT InventoryID, ProductName, ProductType, CurrentStock, PricePerStock, TotalExpense FROM inventory WHERE userID = :userID LIMIT :limit OFFSET :offset";
...
<body>
    ...
    <div class="main-content">
        ...
        <div class="total-expenses">
            <h3>Total Inventory Expenses: ₱<?php echo number_format($totalExpenses, 2); ?></h3>
        </div>
        ...
        <!-- Remove jQuery if not needed elsewhere -->
